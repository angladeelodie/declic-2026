...
export type FooterQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
  pagesMenuHandle: StorefrontAPI.Scalars['String']['input'];
  legalMenuHandle: StorefrontAPI.Scalars['String']['input'];
}>;

export type FooterQuery = {
  pages?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Menu, 'id'> & {
      items: Array<
        Pick<
          StorefrontAPI.MenuItem,
      ...
      references?: StorefrontAPI.Maybe<{
        nodes: Array<
          Pick<StorefrontAPI.Metaobject, 'id' | 'type'> & {
            ...
            link?: StorefrontAPI.Maybe<{
              reference?: StorefrontAPI.Maybe<{
                ...
                page?: StorefrontAPI.Maybe<{
                  reference?: StorefrontAPI.Maybe<
                    Pick<StorefrontAPI.Page, 'handle'>
                  >;
                }>;
              }>;
            }>;
                ...
                Pick<StorefrontAPI.Collection, 'id' | 'title' | 'handle'> & {
                  products: {
                    nodes: Array<
                      Pick<
                        StorefrontAPI.Product,
                        'id' | 'title' | 'productType' | 'tags' | 'handle'
                      > & {
                        featuredImage?: StorefrontAPI.Maybe<
                          Pick<
                            StorefrontAPI.Image,
            ...
            bottomsCollection?: StorefrontAPI.Maybe<{
              reference?: StorefrontAPI.Maybe<
                Pick<StorefrontAPI.Collection, 'id' | 'title' | 'handle'> & {
                  products: {
                    nodes: Array<
            ...
            sleevesCollection?: StorefrontAPI.Maybe<{
              reference?: StorefrontAPI.Maybe<
                Pick<StorefrontAPI.Collection, 'id' | 'title' | 'handle'> & {
                  products: {
                    nodes: Array<
            ...
            button_text?: StorefrontAPI.Maybe<
              Pick<StorefrontAPI.MetaobjectField, 'key' | 'type' | 'value'>
            >;
            tops_collection?: StorefrontAPI.Maybe<{
              reference?: StorefrontAPI.Maybe<
                Pick<StorefrontAPI.Collection, 'id' | 'title' | 'handle'> & {
                  products: {
                    nodes: Array<
                      Pick<StorefrontAPI.Product, 'id' | 'title' | 'handle'> & {
                        featuredImage?: StorefrontAPI.Maybe<
                          ...
                          >
                        >;
                        model?: StorefrontAPI.Maybe<{
                          reference?: StorefrontAPI.Maybe<{
                            sources: Array<
                              Pick<StorefrontAPI.Model3dSource, 'url'>
                            >;
                          }>;
                        }>;
                        options: Array<
            ...
            bottoms_collection?: StorefrontAPI.Maybe<{
              reference?: StorefrontAPI.Maybe<
                Pick<StorefrontAPI.Collection, 'id' | 'title' | 'handle'> & {
                  products: {
                    nodes: Array<
            ...
            sleeves_collection?: StorefrontAPI.Maybe<{
              reference?: StorefrontAPI.Maybe<
                Pick<StorefrontAPI.Collection, 'id' | 'title' | 'handle'> & {
                  products: {
                    nodes: Array<
...
> & {
  ...
  informationPanels?: StorefrontAPI.Maybe<{
    references?: StorefrontAPI.Maybe<{
      nodes: Array<
...
export type CylProductsQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type CylProductsQuery = {
  products: {
    nodes: Array<
      Pick<StorefrontAPI.Product, 'id' | 'title' | 'handle'> & {
        featuredImage?: StorefrontAPI.Maybe<
...
export type SectionEditorialFragment = Pick<
  StorefrontAPI.Metaobject,
  'type'
> & {
  heading?: StorefrontAPI.Maybe<
...
export type SectionItemsGridFragment = Pick<
  StorefrontAPI.Metaobject,
  'type'
> & {
  topsCollection?: StorefrontAPI.Maybe<{
...
export type LookItemFieldFragment = Pick<
  StorefrontAPI.MetaobjectField,
  'type' | 'key' | 'value'
>;

export type LookItemImageFragment = {
  image?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Image, 'altText' | 'url' | 'width' | 'height'>
  >;
};

export type LookItemProductFragment = Pick<
  StorefrontAPI.Product,
  'id' | 'title' | 'handle'
> & {
  featuredImage?: StorefrontAPI.Maybe<
...
export type LookItemFragment = Pick<
  StorefrontAPI.Metaobject,
  'type' | 'id' | 'handle'
> & {
  title?: StorefrontAPI.Maybe<
...
export type SectionLooksSliderFragment = Pick<
  StorefrontAPI.Metaobject,
  'type'
> & {
  title?: StorefrontAPI.Maybe<
...
export type SectionOutfitsAndMediaFragment = Pick<
  StorefrontAPI.Metaobject,
  'type'
> & {
  media?: StorefrontAPI.Maybe<
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query CYLProducts(\n    $country: CountryCode\n    $language: LanguageCode\n  ) @inContext(country: $country, language: $language) {\n    products(first: 20, sortKey: BEST_SELLING) {\n      nodes {\n        id\n        title\n        handle\n        featuredImage {\n          url\n          altText\n        }\n        variants(first: 10) {\n          nodes {\n            id\n            image {\n              url\n              altText\n            }\n            selectedOptions {\n              name\n              value\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    return: CYLProductsQuery;
    variables: CYLProductsQueryVariables;
  };
